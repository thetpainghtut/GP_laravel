                  ...
                  <tbody id="medicineTable">
                    ...
                    <tr>
                        ...
                        <a href="<?php echo e(route('patient.show',$patient->id)); ?>" > <i class="btn fas fa-info text-white" style="background-color: #825ee4"></i></a>
                          ...
                          <form method="post" action="<?php echo e(route('patient.destroy',$patient->id)); ?>" class="d-inline-block">
...
<?php echo $__env->make('frontendTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/GP/resources/views/patients/index.blade.php ENDPATH**/ ?>